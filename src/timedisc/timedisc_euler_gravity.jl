...
function timestep_euler_gravity!(solver_euler, solver_gravity, t::Float64, dt::Float64, time_parameters)
  ...
  time_integration_scheme_gravity = Symbol(parameter("time_integration_scheme_gravity",
                                                      valid=("timestep_gravity_carpenter_kennedy_erk54_2N!",
                                                             ...
                                                             "timestep_gravity_erktmp_3Sstar!")))
...
function timestep_gravity_erktmp_3Sstar!(solver::AbstractSolver, t, dt, u_euler, gravity_parameters)
  # New 3Sstar coefficients optimized for polynomials of degree polydeg=3
  # and examples/parameters_hyp_diff_llf.toml
  # 5 stages, order 1
  ...
  # # 5 stages, order 1, cutoff = -200, alpha = 0.5
  gamma1 = @SVector [0.0000000000000000E+00, 9.5077388368248994E-01, -1.2333555507251082E-01, 5.0656398302269245E-01, -4.8741493564118676E-01]
  gamma2 = @SVector [1.0000000000000000E+00, 4.4457854598589121E-02, 8.0914939149294152E-01, 1.1854091322297214E-02, 6.9683270231797201E-01]
  gamma3 = @SVector [0.0000000000000000E+00, 0.0000000000000000E+00, 0.0000000000000000E+00, 4.6044893933494863E-01, -4.5170243996572762E-01]
  beta   = @SVector [1.2865601449577804E-01, 4.9522946915527877E-01, 6.7131489250826515E-01, 4.8690518662083300E-02, 3.5886730511493553E-01]
  delta  = @SVector [1.0000000000000000E+00, 1.0725352723323447E-01, 2.8103838385610364E-01, 1.3944669478972698E+00, 0.0000000000000000E+00]
  c      = @SVector [0.0000000000000000E+00, 1.2865601449577804E-01, 6.1816571326536951E-01, 7.4681052352190525E-01, 4.4156567686281140E-01]
  # 5 stages, order 2, cutoff = -200, alpha = 0.5
  # gamma1 = @SVector [0.0000000000000000E+00, 1.0104437451374637E+00, -3.4774482797129336E-01, -4.1675475745545931E-01, -1.3577920628292413E+00]
  # gamma2 = @SVector [1.0000000000000000E+00, -8.2696384345740340E-03, 9.8455855454277008E-01, 6.5559654905256870E-01, 6.8745542914912872E-01]
  # gamma3 = @SVector [0.0000000000000000E+00, 0.0000000000000000E+00, 0.0000000000000000E+00, -4.1340468280404788E-02, 8.2884033085761810E-01]
  # beta   = @SVector [7.4337720413165287E-01, 2.3606830339089110E-01, 7.3416599702879115E-01, 1.0090960177317669E-02, 8.0495776879882674E-01]
  # delta  = @SVector [1.0000000000000000E+00, 2.6290226835070979E-01, 1.0598008176729543E-01, 8.5519162928750203E-01, 0.0000000000000000E+00]
  # c      = @SVector [0.0000000000000000E+00, 7.4337720413165287E-01, 9.8559296822121734E-01, 6.8668920022615287E-01, 3.0551565069982806E-01]
  # 5 stages, order 1, cutoff_real = -200, cutoff_abs = 200, alpha = 0.8
  # gamma1 = @SVector [0.0000000000000000E+00, 9.3339107248987530E-01, 4.1584056832779892E-01, -3.2815540194193566E+00, 3.1720912626657216E-01]
  # gamma2 = @SVector [1.0000000000000000E+00, 6.2044453310371089E-02, 4.0131298377443797E-01, 1.1725058506172037E+00, 5.3381625761390572E-01]
  # gamma3 = @SVector [0.0000000000000000E+00, 0.0000000000000000E+00, 0.0000000000000000E+00, 9.8747205710731367E-01, -8.1693256429398220E-01]
  # beta   = @SVector [1.0661102226042181E+00, 1.9177122129268193E-01, 1.5267664020128004E+00, 2.6306527608488067E-01, 1.8748908123143355E-02]
  # delta  = @SVector [1.0000000000000000E+00, 7.3567804311535159E-02, 3.8205275941419231E-01, 1.3538169845628782E+00, 0.0000000000000000E+00]
  # c      = @SVector [0.0000000000000000E+00, 1.0661102226042181E+00, 1.1917352179668232E+00, 2.2365338872210305E+00, -2.9002508914807694E+00]
